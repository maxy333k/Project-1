...
weedle2 = Pokemon('weedle', v_forest1, {'poisonsting': 7}, 'bryce\'s hairy bug pokemon')
pika = Pokemon('pikachu', route_2, {'volttackle': 13}, 'mike\'s pikachu')
scyth = Pokemon('scyther', v_forest6, {'slash': 15}, 'dillon\'s mantis pokemon')
cubone = Pokemon('cubone', pcg7, {'bonemerang': 19}, 'grant\'s lonely pokemon')
onix = Pokemon('onix', brock, {'irontail': 21,}, 'brock\'s rock snake pokemon')
diglett = Pokemon('diglett', pcg4, {'dig': 17,}, 'david\'s mole pokemon')
